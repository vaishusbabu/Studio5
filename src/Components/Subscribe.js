                            ...
                            <div>
                                <div className="share-page en">
                                    ...
                                    <a
                                        ...
                                        href="https://www.facebook.com/sharer/sharer.php?u=http://51.136.51.121/en/subscribe&amp;src=sdkpreparse"
                                    ...
                                    <a
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        href="http://twitter.com/share?text=Studio 5   Home&amp;url=http://51.136.51.121/en/subscribe"
                                    >
                                        <span>acebook</span>
                ...
                <div id="main-container">
                    <div id="skipContent"
                        ...
                        <div className="row col-2">
                                ...
                                <form name="subscribe" className="subscribe-form">
                                                ...
                                                <div style={{ margin: 0 }}>
                                                    <div>
                                                        ...
                                                        <label
                                                            ...
                                                            className="custom-radio-style"
                                                        >
                                                            <span className="custom-radio-style">Other</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <input type="hidden" name="webform_id" defaultValue="" />
                                    ...
                                    <div className="btn-wrap">
                                        <button
                                            ...
                                            style={{ margin: "0px 0px 5px", textTransform: "uppercase" }}
                                        >
                                        ...
                                        <div className="modal-content">
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    ...
                                                    commercial use. Personal information will not be forwarded
                                                    to third parties unless MCIT is required by law or that
                                                    entity is relevant to your enquiry.
                                                </p>
                                                <p>
                                                    This statement relates to our privacy practices in
                                                    connection with this website. We are not responsible for the
                                                    content or privacy practices o
                                                </p>
                                                <div
                            ...
                            <div className="item">
                                <img
                                    src="/static/media/subscribe-right.03a04c46a580b19e1c75.png"
                                    alt=""
                                />
                            </div>
                        </div>
